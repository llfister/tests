...
use LL\PlatformBundle\Entity\Variant;
use LL\PlatformBundle\Form\VariantType;
...
class VariantController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LLPlatformBundle:Variant')->findAll();
     ...
     * @Method("POST")
     * @Template("LLPlatformBundle:Variant:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LLPlatformBundle:Variant')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("LLPlatformBundle:Variant:edit.html.twig")
     */
